...
```{r  setUp, include=FALSE}
 library(tidyverse) 
      ...
      EntryData <- readRDS(paste0("./", dir("./")[str_detect(dir("./"), "_xx97-112-105-111xx_.rds")]))
...
<small> id: </small> <a href=' http://lila-erc.eu/data/id/lemma/89451 ' target="_blank"> http://lila-erc.eu/data/id/lemma/89451 </a> <br>
